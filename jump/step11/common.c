...
inline uint32_t little2host32(uint32_t n)
{
    return little32(n);
}

inline uint16_t little2host16(uint16_t n)
{
    return little16(n);
}

inline uint32_t big2host32(uint32_t n)
{
    return big32(n);
}

inline uint16_t big2host16(uint16_t n)
{
    return big16(n);
}
